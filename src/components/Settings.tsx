...
export default ({ Manifest }) => {
  const [isStrange, setIsStrange] = React.useState(
    get(Manifest.name, "strangeCode", 0),
  );
  ...
  return (
    <>
            ...
            <FormSwitch
              ...
              onValueChange={() => {
                ...
                set(
                  Manifest.name,
                  "strangeCode",
                  get(Manifest.name, "strangeCode", 0) == 0 ? 1 : 0,
                );

                Toasts.open({
                  content: locale.toasts.strangeText(
                    get(Manifest.name, "strangeCode", 0) == 0
                      ? "Enabled"
                      : "Disabledetta",
                  )[isStrange],
      ...
      <FormText style={styles.info}>
        {locale.settings.info()[isStrange]}
      </FormText>
    </>
  );
};
